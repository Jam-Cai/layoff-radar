          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="text-center lg:text-left">
                ...
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-white shadow-md text-lg text-gray-700 mb-10">
                  Welcome to eliminating systemic <span className="font-semibold text-purple-600 ml-1">bias</span>
                </div>
              </div>

              <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
                <Card className="p-6 border-0 shadow-lg hover:shadow-xl transition-shadow bg-white/60 backdrop-blur-md">
                  <h3 className="text-xl font-semibold mb-3">What is Layoff Radar?</h3>
                  <p className="text-gray-600">
                    A tool that helps you stay ahead of workforce changes with AI-powered layoff risk analysis. Get real-time insights into potential company restructuring.
                  </p>
                </Card>
                
                <Card className="p-6 border-0 shadow-lg hover:shadow-xl transition-shadow bg-white/60 backdrop-blur-md">
                  <h3 className="text-xl font-semibold mb-3">Why Layoff Radar?</h3>
                  <p className="text-gray-600">
                ...
                <Card className="p-6 border-0 shadow-lg hover:shadow-xl transition-shadow bg-white/60 backdrop-blur-md">
                  <h3 className="text-xl font-semibold mb-3">How was Layoff Radar built?</h3>
            ...
            <div className="lg:col-span-1 flex items-center">
              <Card className="p-6 border-0 shadow-lg w-full bg-white/60 backdrop-blur-md transform translate-y-8">
                ...
                <Link to="/dashboard">
                  <Button size="lg" className="w-full bg-indigo-600 hover:bg-indigo-700 text-lg">
